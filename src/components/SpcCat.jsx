...
function SpcCat() {
    ...
    return (
        <div className=' select-none w-full max-w-[1200px] mx-auto px-5 '>
            <h1 className='text-gray-700 mt-5 md:mt-10 mb-5 text-3xl font-medium flex items-center gap-2'> {cat} </h1>
            <div className='my-5 md:my-10 border rounded-full w-full max-w-md h-11 flex items-center gap-2 px-1 text-gray-600 drop-shadow-md bg-white'>
                ...
                }
                {
                    ...
                    <div className='mx-auto w-full max-w-[1200px] grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5'>
                    {finalproducts} 
                    </div>
                    :
                    search?
